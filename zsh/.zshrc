...
alias lm="eza -l --icons --group-directories-first --sort=modified --reverse"
alias lma="eza -la --icons --group-directories-first --sort=modified --reverse"
alias lz="eza -lf --icons --sort=size --reverse"
alias lza="eza -laf --icons --sort=size --reverse"

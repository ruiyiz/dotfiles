...
alias lm="eza -l --icons --grid --group-directories-first --sort=modified --reverse"
alias lma="eza -la --icons --grid --group-directories-first --sort=modified --reverse"
alias lla="eza -la --icons --grid --group-directories-first"
alias lz="eza -lf --icons --grid --sort=size --reverse"
alias lza="eza -laf --icons --grid --sort=size --reverse"
